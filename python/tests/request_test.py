...
print(GetActiveValue())
print(GetLectureFrequencyValue())
print(GetSensorsFrequencyValue())
print(GetLocalIpValue())
print(GetLocalUsernameValue())
print(GetLocalPasswordValue())